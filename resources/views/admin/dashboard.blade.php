            ...
            <div class="profile">
               <div class="profile-header">
                  ...
                  <div class="profile-header-content">
                     ...
                     <img src="{{asset( '/storage/public/images//'.$profile->image)}}" alt="">
                     </div>
                     <!-- END profile-header-img -->
                     <!-- BEGIN profile-header-info -->
                     <div class="profile-header-info">
                        <h4 class="m-t-10 m-b-5">{{$profile->fname }} {{$profile->lname}}</h4>
                        <p class="m-b-10">{{$profile->email}}/{{$profile->phone}}</p>
                        <p class="m-b-10">{{auth()->user()->role}}</p>
                        <a href="{{route('user.edit',$profile->id)}}" class="btn btn-sm btn-info mb-2">Edit Profile</a>
                        <a href="{{URl('chatify')}}" class="fas fa-comments">Chat</a> 
                  ...
                  <ul class="profile-header-tab nav nav-tabs">
                     <li class="nav-item"><a href="#profile-post" class="nav-link active show" data-toggle="tab">USERS</a></li>
                     <li class="nav-item"><a href="#profile-about" class="nav-link" data-toggle="tab">ABOUT</a></li>
                     <li class="nav-item"><a href="#profile-photos" class="nav-link" data-toggle="tab">DATA CHARTS</a></li>
                     <li class="nav-item"><a href="#profile-videos" class="nav-link" data-toggle="tab">REQUEST({{$total}})</a></li>
            ...
            <div class="profile-content">
               ...
               <div class="tab-content p-0">
                  ...
                  <!-- end #profile-post tab -->
                    ...
                    <!-- begin #profile-post tab -->
                    <div class="tab-pane fade active show" id="profile-photos">
                     <!-- begin timeline --> 
                        <div class="">
                                ...
                                <div class="row">
                                        ...
                                        <div  class="col-sm-6 col-md-6 well">
                                                @if(empty($userschart))
                                                    <div id="app2"></div>
                                                @else
                                                    <div id="app2">{!! $userschart->container() !!}</div>
                                                    {!! $userschart->script() !!}
                                                @endif  
                                        </div> 
                  ...
                  <!-- end #profile-post tab -->
                    ...
                    <!-- begin #profile-post tab -->
                    <div class="tab-pane fade active show" id="profile-videos">
                     <!-- begin timeline --> 
                     <div style="overflow-x:auto;">
                     <table class="table table-striped well " style="width:100%">
                     <thead>
                        <tr>
                            <th>AnimalID</th>
                            <th>AnimalName</th>
                        ...
                        <tbody>
                         @foreach($newdata as $data)
                          <tr>
                            ...
                            <td>ID:{{$data->adopter_id}}</td> 
                            <td>{{$data->email}}</td>  
                            <td>{{$data->status}}</td>
                            <td> 
                            <form action="{{route('updateadopted.update',$data->animal_id)}}" method="post"> 
                                {{ method_field('PUT') }}
                                {{ csrf_field() }}

                                {{ Form::hidden('animal_id',$data->animal_id,array('class' => 'form-control')) }}
                            {{ Form::hidden('adopter_id',$data->adopter_id,array('class' => 'form-control')) }}
                            ...
                            <form action="{{route('destroyadopted.destroy',$data->animal_id)}}" method="post"> 
        ...
        <div class="col-md-8">  
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    ...
                    <h6>Birthdate<h6> 
                    {{ Form::text('birth_date',$profile->phone,array('class' => 'form-control')) }}
                    <h6>User_Id<h6> 
