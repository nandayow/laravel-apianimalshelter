        ...
        <div class="col-md-6">
            <div class="vertical-tab" role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab"> <i class="fa fa-envelope"></i></a></li>
                ...
                <div class="tab-content tabs">
                    <div role="tabpanel" class="tab-pane fade in active" id="Section1">   
                        ...
                        <div class="message-header"> 
                         <a   aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-user"> From:{{$email->sender}}</i></a> 
                        </div>
                        <br>
                        <div class="message-text">
                                    <p>{{$email->message}}</p>
                         </div>   
                         <a class = "btn btn-primary btnb1"   href = "{{route('email.index')}}">Back</a>
                        @endforeach   
                    </div>
