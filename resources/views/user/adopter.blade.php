               ...
               <div class="profile-header">
                  ...
                  <div class="profile-header-content">
                     ...
                     <div class="profile-header-info">
                        <h4 class="m-t-10 m-b-5">{{$profile->fname }} {{$profile->lname}}<a href="{{URL('mustverify')}}" class="fas fa-check"></a></h4>
                        <p class="m-b-10">{{auth()->user()->email}}/{{$profile->phone}}</p>
                  ...
                  <ul class="profile-header-tab nav nav-tabs">
                     <li class="nav-item"><a href="#profile-post" class="nav-link active show" data-toggle="tab">Records</a></li>
